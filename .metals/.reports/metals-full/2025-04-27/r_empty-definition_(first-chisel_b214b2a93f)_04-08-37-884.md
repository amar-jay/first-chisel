error id: file://<WORKSPACE>/mini-gpu/dispatch.scala:20
...
non-local guesses:
	 -chisel3/ConsumerIO#
	 -chisel3/util/ConsumerIO#
	 -chiseltest/ConsumerIO#
	 -ConsumerIO#
	 -scala/Predef.ConsumerIO#
offset: 777
...
class ConsumerIO@@(dataWidth:Int, addrWidth: Int) extends Bundle {
	val read = Flipped(Decoupled(
		val address = UInt(addrWidth.W)
	))
	val data = IO(UInt(dataWidth.W))
