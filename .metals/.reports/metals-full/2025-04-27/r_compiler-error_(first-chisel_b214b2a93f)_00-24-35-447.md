file://<WORKSPACE>/6_control_register.scala
### java.lang.StringIndexOutOfBoundsException: offset 614, count -11, length 806
...
action parameters:
offset: 617
uri: file://<WORKSPACE>/6_control_register.scala
text:
```scala
//> using scala "2.13.12"
