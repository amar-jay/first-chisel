error id: file://<WORKSPACE>/mini-gpu/dispatch.scala:67
...
non-local guesses:
	 ...
	 -chisel3/numChannels#
	 -chisel3/numChannels().
	 -chisel3/util/numChannels.
	 -chisel3/util/numChannels#
	 -chisel3/util/numChannels().
	 -chiseltest/numChannels.
	 -chiseltest/numChannels#
	 -chiseltest/numChannels().
	 -numChannels.
	 -numChannels#
	 -numChannels().
	 -scala/Predef.numChannels.
	 -scala/Predef.numChannels#
	 -scala/Predef.numChannels().
offset: 2363
  ...
  withReset (reset.asBool) {
	// clear the channel state
	 for (i <- 0 until numChannels@@) {
		...
		channels(i).read.bits.address := 0.U
		channels.
