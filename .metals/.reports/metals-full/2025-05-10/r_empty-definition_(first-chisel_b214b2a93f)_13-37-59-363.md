error id: file://<WORKSPACE>/riscv/decoder.scala:447
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/expectedInstType.
	 -chisel3/expectedInstType#
	 -chisel3/expectedInstType().
	 -chisel3/util/expectedInstType.
	 -chisel3/util/expectedInstType#
	 -chisel3/util/expectedInstType().
	 -chiseltest/expectedInstType.
	 -chiseltest/expectedInstType#
	 -chiseltest/expectedInstType().
	 -riscv/Instructions.expectedInstType.
	 -riscv/Instructions.expectedInstType#
	 -riscv/Instructions.expectedInstType().
	 -expectedInstType.
	 -expectedInstType#
	 -expectedInstType().
	 -scala/Predef.expectedInstType.
	 -scala/Predef.expectedInstType#
	 -scala/Predef.expectedInstType().
offset: 13241
