error id: file://<WORKSPACE>/riscv/decoder.scala:249
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/expectedCsrCmd/B.
	 -chisel3/expectedCsrCmd/B#
	 -chisel3/expectedCsrCmd/B().
	 -chisel3/util/expectedCsrCmd/B.
	 -chisel3/util/expectedCsrCmd/B#
	 -chisel3/util/expectedCsrCmd/B().
	 -chiseltest/expectedCsrCmd/B.
	 -chiseltest/expectedCsrCmd/B#
	 -chiseltest/expectedCsrCmd/B().
	 -riscv/Instructions.expectedCsrCmd.B.
	 -riscv/Instructions.expectedCsrCmd.B#
	 -riscv/Instructions.expectedCsrCmd.B().
	 -expectedCsrCmd/B.
	 -expectedCsrCmd/B#
	 -expectedCsrCmd/B().
	 -scala/Predef.expectedCsrCmd.B.
	 -scala/Predef.expectedCsrCmd.B#
	 -scala/Predef.expectedCsrCmd.B().
offset: 8013
...
class InstructionDecoderTest extends AnyFlatSpec with ChiselScalatestTester {
  ...
  def testInstruction(
    ...
    dut.io.rf_wen.expect(expectedRfWen.B)
	 dut.io.csr_cmd_en.expect(expectedCsrCmd.B@@)
