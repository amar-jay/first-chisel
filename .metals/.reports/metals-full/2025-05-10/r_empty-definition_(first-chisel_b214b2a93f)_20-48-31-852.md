error id: file://<WORKSPACE>/riscv/decoder.scala:381
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/expectedRdAddr.
	 -chisel3/expectedRdAddr#
	 -chisel3/expectedRdAddr().
	 -chisel3/util/expectedRdAddr.
	 -chisel3/util/expectedRdAddr#
	 -chisel3/util/expectedRdAddr().
	 -chiseltest/expectedRdAddr.
	 -chiseltest/expectedRdAddr#
	 -chiseltest/expectedRdAddr().
	 -riscv/Instructions.expectedRdAddr.
	 -riscv/Instructions.expectedRdAddr#
	 -riscv/Instructions.expectedRdAddr().
	 -expectedRdAddr.
	 -expectedRdAddr#
	 -expectedRdAddr().
	 -scala/Predef.expectedRdAddr.
	 -scala/Predef.expectedRdAddr#
	 -scala/Predef.expectedRdAddr().
offset: 11851
