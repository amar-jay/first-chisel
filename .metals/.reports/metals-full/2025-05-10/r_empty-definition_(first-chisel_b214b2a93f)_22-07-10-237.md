error id: file://<WORKSPACE>/riscv/constants.scala:143
...
non-local guesses:
	 -chisel3/fullMapping.
	 -chisel3/util/fullMapping.
	 -chiseltest/fullMapping.
	 -Instructions.fullMapping.
	 -ALUOperations.fullMapping.
	 -fullMapping.
	 -scala/Predef.fullMapping.
offset: 2489
...
object InstructionToALU {
  ...
  import ALUOperations._
    ...
    fullMa@@pping.getOrElse(instr, NOP) // Default to NOP if not found
  }
}
