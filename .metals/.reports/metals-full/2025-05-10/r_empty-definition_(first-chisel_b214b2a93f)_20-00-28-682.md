error id: file://<WORKSPACE>/riscv/decoder.scala:526
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/INSTRUCTIONS.
	 -chisel3/INSTRUCTIONS#
	 -chisel3/INSTRUCTIONS().
	 -chisel3/util/INSTRUCTIONS.
	 -chisel3/util/INSTRUCTIONS#
	 -chisel3/util/INSTRUCTIONS().
	 -chiseltest/INSTRUCTIONS.
	 -chiseltest/INSTRUCTIONS#
	 -chiseltest/INSTRUCTIONS().
	 -riscv/Instructions.INSTRUCTIONS.
	 -riscv/Instructions.INSTRUCTIONS#
	 -riscv/Instructions.INSTRUCTIONS().
	 -INSTRUCTIONS.
	 -INSTRUCTIONS#
	 -INSTRUCTIONS().
	 -scala/Predef.INSTRUCTIONS.
	 -scala/Predef.INSTRUCTIONS#
	 -scala/Predef.INSTRUCTIONS().
offset: 16005
...
class InstructionFetcher extends Module {
  ...
  val u_imm = Cat(io.inst(31, 12), 0.U(12.W))
	//  val b_imm = Cat(Fill(19, io.inst(31)), io.inst(31), io.inst(7), io.inst(30, 25), io.inst(11, 8), 0.U(1.W)) // Sign-extended
	 val j_imm = Cat(Fill(43, io.inst(31)), io.inst(31), io.inst(19, 12), io.inst(20), io.inst(30, 21), 0.U(1.W)) // Sign-extended
