error id: file://<WORKSPACE>/riscv/decoder.scala:154
...
non-local guesses:
	 ...
	 -chisel3/io/csr_cmd#
	 -chisel3/io/csr_cmd().
	 -chisel3/util/io/csr_cmd.
	 -chisel3/util/io/csr_cmd#
	 -chisel3/util/io/csr_cmd().
	 -chiseltest/io/csr_cmd.
	 -chiseltest/io/csr_cmd#
	 -chiseltest/io/csr_cmd().
	 -riscv/Instructions.io.csr_cmd.
	 -riscv/Instructions.io.csr_cmd#
	 -riscv/Instructions.io.csr_cmd().
	 -io/csr_cmd.
	 -io/csr_cmd#
	 -io/csr_cmd().
	 -scala/Predef.io.csr_cmd.
	 -scala/Predef.io.csr_cmd#
	 -scala/Predef.io.csr_cmd().
offset: 5091
...
class InstructionDecoderTest extends AnyFlatSpec with ChiselScalatestTester {
  ...
  def testInstruction(
   ...
   //  dut.io._op.expect(expectedOp)
    ...
    dut.io.csr_cmd.expect(expectedCsrCmd.U)
