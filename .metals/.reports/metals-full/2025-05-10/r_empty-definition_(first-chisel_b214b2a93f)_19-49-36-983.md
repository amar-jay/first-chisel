error id: file://<WORKSPACE>/riscv/decoder.scala:71
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/dec_inst_data.
	 -chisel3/dec_inst_data#
	 -chisel3/dec_inst_data().
	 -chisel3/util/dec_inst_data.
	 -chisel3/util/dec_inst_data#
	 -chisel3/util/dec_inst_data().
	 -chiseltest/dec_inst_data.
	 -chiseltest/dec_inst_data#
	 -chiseltest/dec_inst_data().
	 -riscv/Instructions.dec_inst_data.
	 -riscv/Instructions.dec_inst_data#
	 -riscv/Instructions.dec_inst_data().
	 -dec_inst_data.
	 -dec_inst_data#
	 -dec_inst_data().
	 -scala/Predef.dec_inst_data.
	 -scala/Predef.dec_inst_data#
	 -scala/Predef.dec_inst_data().
offset: 2712
...
class InstructionFetcher extends Module {
  ...
  val j_imm_sext_      = Cat(Fill(11, dec_inst_@@data(31)), dec_inst_data(31), dec_inst_data(19,12), dec_inst_data(20), dec_inst_data(30,21), 0.U(1.W))
