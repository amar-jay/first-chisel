error id: file://<WORKSPACE>/riscv/core.scala:151
			...
			when(inst_fetcher.io._op === Instructions.I_I_JALR) {
               ...
               switch(inst_fetcher.io._op) {
                  ...
                  is(Instructions.I_I_LW) {
                     // Word
                     regfile.io.write.data := io@@.mem_read_data.asSInt
                  }
                  is(Instructions.I_I_LBU) {
                  	// Zero-extended byte
                     regfile.io.write.data := Cat(0.U(24.W), io.mem_read_data(7, 0)).asSInt
                  }
