error id: file://<WORKSPACE>/riscv/register.scala:26
...
class RegIo(xlen: Int, mem_add_len:Int) extends Bundle {
  val read0 = new ReadPortIo(xlen, mem_add_len)
 ...
 * 
 * This module imp@@lements a 32-entry register file for a RISC-V processor with the
 * following features:
 *
