error id: file://<WORKSPACE>/riscv/constants.scala:230
file://<WORKSPACE>/riscv/constants.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/R_Instructions#
	 -chisel3/util/R_Instructions#
	 -chiseltest/R_Instructions#
	 -R_Instructions#
	 -scala/Predef.R_Instructions#
offset: 4713
...
object I_Instructions_ALU extends ChiselEnum {
	// not sure about this
...
object I_Instructions_LOAD extends ChiselEnum {
	// LOAD operations
	val I_LB,
	I_LH,
	I_LW,
...
object I_Instructions_CSR extends ChiselEnum {
	// CSR operations
	val I_ECALL,
	I_EBREAK = Value
}

object I_Instructions_JUMP extends ChiselEnum {
	// JUMP operations
	val I_JALR = Value
}
...
trait I_Instructions {
	val alu = I_Instructions_ALU
	val load = I_Instructions_LOAD
	val csr = I_Instructions_CSR
	val jump = I_Instructions_JUMP
}

object ALU_Operations extends R_Instr@@uctions with I_Instructions {
}
```
