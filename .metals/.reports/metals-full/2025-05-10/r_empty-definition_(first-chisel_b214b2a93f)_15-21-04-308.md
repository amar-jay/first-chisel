error id: file://<WORKSPACE>/riscv/alu.scala:189
file://<WORKSPACE>/riscv/alu.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/dut/io/overflow.
	 -chisel3/util/dut/io/overflow.
	 -chiseltest/dut/io/overflow.
	 -dut/io/overflow.
	 -scala/Predef.dut.io.overflow.
offset: 5850
...
class ALUTest extends AnyFlatSpec with ChiselScalatestTester {
  ...
  it should "handle division by zero" in {
    test(new ALU()) { dut =>
      ...
      dut.io.op.poke(ALUOperations.DIV)
      dut.clock.step()
		dut.io.result.expect(0.U) // Division by zero should return 0
      dut.io.overflow@@.expect(true.B)
		dut.io.zero.expect(true.B) // Zero flag should be set
