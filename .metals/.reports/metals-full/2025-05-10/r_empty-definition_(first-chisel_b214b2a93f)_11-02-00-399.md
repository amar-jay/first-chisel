error id: file://<WORKSPACE>/riscv/decoder.scala:116
file://<WORKSPACE>/riscv/decoder.scala
empty definition using pc, found symbol in pc: 
semanticdb not found
empty definition using fallback
non-local guesses:
	 -chisel3/I_Operations.I_SRAI.
	 -chisel3/I_Operations.I_SRAI#
	 -chisel3/I_Operations.I_SRAI().
	 -chisel3/util/I_Operations.I_SRAI.
	 -chisel3/util/I_Operations.I_SRAI#
	 -chisel3/util/I_Operations.I_SRAI().
	 -chiseltest/I_Operations.I_SRAI.
	 -chiseltest/I_Operations.I_SRAI#
	 -chiseltest/I_Operations.I_SRAI().
	 -riscv/I_Operations.I_SRAI.
	 -riscv/I_Operations.I_SRAI#
	 -riscv/I_Operations.I_SRAI().
	 -I_Operations.I_SRAI.
	 -I_Operations.I_SRAI#
	 -I_Operations.I_SRAI().
	 -scala/Predef.I_Operations.I_SRAI.
	 -scala/Predef.I_Operations.I_SRAI#
	 -scala/Predef.I_Operations.I_SRAI().
offset: 3723
			...
			switch (funct3) {
				...
				is ("h5".U) {
					...
					when (funct7(5)) { // checking the 6th bit of funct7, does pretty much the same as the above
						io.alu_op := I_Operations.I_SR@@AI
					}.otherwise {
