error id: file://<WORKSPACE>/riscv/core.scala:162
    ...
    switch(inst_fetcher.io.inst_type) {
      is(InstructionTypes.R_TYPE) {
		...
		is(InstructionTypes.I_TYPE) {
			...
			}.elsewhen(inst_fetcher.io.inst_type === InstructionTypes.I_TYPE2) {
				   // Load instructions
            	regfile.io.write.en := true.B
               regfile.io.write.addr := rd_addr
               io.mem_addr := (rs1_data.asUInt + inst_fetcher.io.imm)
