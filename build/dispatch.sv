...
module Dispatcher(
  ...
  input  [31:0] io_consumers_0_read_bits_data,
  ...
  input  [31:0] io_consumers_1_read_bits_data,
  ...
  input  [31:0] io_consumers_2_read_bits_data,
  ...
  input  [31:0] io_consumers_3_read_bits_data,
  ...
  assign io_consumers_0_read_ready = io_consumers_0_read_valid;
  assign io_consumers_0_write_ready = io_consumers_0_read_valid;
  ...
  assign io_channels_0_write_valid = 1'h1;
  ...
  assign io_channels_1_write_valid = 1'h1;
